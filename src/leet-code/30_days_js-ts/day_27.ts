...
// to the one found in Node.js or the Event Target interface of the DOM. The EventEmitter should allow for subscribing to events and emitting them.
//
...
class EventEmitter {
    private readonly events: { [event: string]: Callback[] };
    constructor() {
        this.events = {};
    }
